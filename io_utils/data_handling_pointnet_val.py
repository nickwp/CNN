...
class WCH5DatasetV(Dataset):
    ...
    def __init__(self, trainval_dset_path, trainval_idx_path, geo_path, norm_params_path, chrg_norm="identity", time_norm="identity", shuffle=1, trainval_subset=None, num_datasets = 1, seed=42, npoints=4000):
